...
docker run --network host -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t $applicationURL:$PORT/v3/api-docs -f openapi -c gen_file -w report.md -J json_report.json -r zap_report.html
